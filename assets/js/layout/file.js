            ...
            $(this).on('change', function (index) {
                ...
                if (fileVal.length > 0) {
                    ...
                    if (fileName.length > 0) {
                        ...
                        result.eq(fileIndex).html('<div class="result"><div><a class="material-icons">attachment</a><span>' + fileName + '</span><button type="button" class="file_del material-icons">close</button></div></div>'
                        );
