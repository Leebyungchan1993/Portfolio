...
while($row = mysqli_fetch_array($result)){
    ...
    // <li>
    //     <div class="num">3</div>
    //     <div class="title"><a href=""><span class="lock"><span>테스트01테스트01테스트01테스트01테스트01테스트01테스트01테스트01</span></span> </a></div>
    //     <div class="name">테스트01</div>
    //     <div class="result_info">
    //         <div class="view">1views</div>
    //         <div class="date">2002-06-21</div>
    //         <div class="status"><span><span>미확인</span></span></div>
    //     </div>
    // </li>
            ...
            <div class="board_wrap">
                ...
                <div class="table_wrap">
                    ...
                    <div class="table_pagination">
                        <a href="#;" class="material-icons">keyboard_arrow_left</a>
                        <a href="#;" class="on">1</a>
                        <a href="#;" class="">2</a>
                        <a href="#;" class="">3</a>
                        <a href="#;" class="">4</a>
                        <a href="#;" class="">5</a>
                        <a href="#;" class="material-icons">chevron_right</a>
                    </div>
                </div>
            </div>
        </section>
