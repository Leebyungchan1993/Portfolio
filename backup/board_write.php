            ...
            <div class="form_wrap">
                <form action="./board/insert.php" method="POST">
                    ...
                    <div>
                        <dl>
                            <dt>작성자</dt>
                            <dd><input type="text" placeholder="홍길동" name="name" id="name" maxlength="16" require></dd>
                        </dl>
                    ...
                    <div>
                        <dl>
                            <dt>연락처</dt>
                            <dd class="phone_box">
                                <input type="text" placeholder="010" name="phone1" id="phone01" maxlength="3" require>
                                <span>-</span>
                                <input type="text" placeholder="1234" name="phone2" id="phone02" maxlength="4" require>
                                <span>-</span>
                                <input type="text" placeholder="5678" name="phone3" id="phone03" maxlength="4" require>
                            </dd>
                        </dl>

                        <dl class="email_box">
                            <dt>이메일</dt>
                            <dd><input type="email" placeholder="qudcks5078@naver.com" name="email" id="email" require>
                            </dd>
                        </dl>
                    </div>
                    ...
                    <dl>
                        <dt>제목</dt>
                        <dd>
                            <input type="text" placeholder="제목을 입력해주세요." name="title" id="title" maxlength="12" require>
                        </dd>
                    </dl>
                    <dl>
                        <dt>비밀번호</dt>
